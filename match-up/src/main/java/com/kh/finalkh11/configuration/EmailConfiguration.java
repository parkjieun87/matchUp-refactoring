...
public class EmailConfiguration {
	...
	public JavaMailSenderImpl sender() {
		...
		props.setProperty("mail.smtp.auth", "true");//인증 후 이용
		...
		props.setProperty("mail.smtp.ssl.trust", "smtp.gmail.com");//신뢰할 수 있는 사이트 설정
