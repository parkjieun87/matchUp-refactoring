        ...
        <div class="row">
            <div class="offset-md-1 col-md-9">
                <div class="row fs-2 text-center">
                    서비스 이용 약관(Terms of Use)
                </div>
                <div class="row mt-4">
                    <pre>
제 1조 목적
이 약관은 마이플레이컴퍼니 (이하 “회사”)에서 제공하는 회사 및 회사에서 제공하는 제반 서비스(이하 "서비스")에 접속과 사용자에 의해서 업로드 및 다운로드 되어 표시되는 모든 정보, 텍스트, 이미지 및 기타 자료를 이용하는 이용자(이하 "회원")와 서비스 이용에 관한 권리 및 의무와 책임사항, 기타 필요한 사항을 규정하는 것을 목적으로 합니다.
...
제 4조 용어의 정의
1. 서비스: 개인용 컴퓨터 (PC), TV, 휴대형 단말기, 전기통신설비 등 포함 각종 유무선 장치와 같이 구현되는 단말기와 상관없이 회원이 이용할 수 있는 회사 및 회사 관련 제반 서비스를 의미합니다. 제반 서비스에는 개발자 및 서비스 제공자가 회사 Open Application Programming Interface 서비스와 이를 이용하여 개발한 API 응용 애플리케이션 또는 웹서비스도 포함됩니다.
...
7. 유료서비스: 회사가 유료로 제공하는 각종 제반 서비스를 의미합니다. 
8. 포인트: 회사의 유료 콘텐츠를 이용하기 위해 회원이 구입하는 사이버 머니를 말합니다.

제 5조 이용계약의 체결
1. 이용계약은 회원이 회사 서비스 및 제반 서비스에서 제공하는 회원 가입 페이지에서 서비스 이용약관에 동의한 후 이용신청을 하고 신청한 내용에 대해서 회사가 승낙함으로써 체결됩니다.
...
- 자동 접속 프로그램등을 사용하는 등 정상적인 용법과 다른 방법으로 서비스를 이용하여 회사의 서버에 부하를 일으켜 회사의 정상적인 활동을 방해하는 행위
...
7. 회사가 제공하는 유료서비스는 대한민국에서만 이용 가능합니다. 
...
3. 회원은 회사에서 정하고 있는 방법으로 유료서비스의 결제가 가능합니다. 단, 미성년 회원의 결제는 원
칙적으로 보호자(법정대리인)의 명의 또는 동의 하에 이루어져야 하고, 보호자(법정대리인)는 본인 동의
없이 체결된 자녀(미성년자)의 계약을 취소할 수 있습니다.

제 19조 청약의 철회
1. 회사와 포인트 이용에 관한 계약을 체결한 회원은 7일 이내에 충전한 포인트에 한해서 청약을 철회를 할 수 있습니다.
...
- 충전 후 7일 이상 지난 경우
3. 회사는 청약철회 등이 불가능한 경우에는 그 사실을 회원이 쉽게 알 수 있도록 안내하여 청약철회 등의 권리 행사가 방해 받지 아니하도록 조치하여야합니다.
4.소비자는 제 1항 및 제 2항에도 불구하고 포인트의 내용이 표시 광고의 내용과 다르거나 계약내용과 다르게 이행된 경우에는 그 포인트를 공급받은 날로부터 3개월 이내, 그 사실을 안 날 또는 알 수 있었던 날부터 30일 이내에 청약철회를 할 수 있습니다. 회원은 회사의 고객센터를 통해 청약철회를 신청할 수 있습니다.

제 20조 청약 철회의 효과 및 환불
1. 회사의 귀책사유로 회원이 유료서비스를 이용할 수 없게 된 경우, 회사는 회사의 귀책범위 내에서 환불하거나 결제를 취소합니다. 단, 무상으로 지급된 포인트는 환불대상에서 제외됩니다.
...
부칙
1. 본 약관은 2019년 9월 6일부터 적용됩니다.</pre>
                </div>
            </div>
        </div>
    </div>
